...
public class FSSourceFile {
  ...
  public FSSourceFile(Path vPath) {
    if (!validExtension(vPath)) throw new IllegalArgumentException("Invalid source fileName name.");
  ...
  public Path classPath() {
    ...
    if (parent != null) return Paths.get(parent.toString(), prefix() + ".class");
    else return Paths.get(prefix() + ".class");
  }
  ...
  public String slashName() {
    ...
    if (parent != null) return Paths.get(parent.toString(), prefix()).toString();
    else return Paths.get(prefix()).toString();
  }
