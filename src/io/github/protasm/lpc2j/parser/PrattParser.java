...
public class PrattParser {
    ...
    static {
        ...
        tokenTypeToRule.put(T_FALSE, new ParseRule(new LiteralParselet(), null, PREC_NONE));
        ...
        tokenTypeToRule.put(T_TRUE, new ParseRule(new LiteralParselet(), null, PREC_NONE));
    }
